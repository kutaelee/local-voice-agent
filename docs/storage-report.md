...
The currently pinned default and exact-MTP model set is approximately
113.60 GiB of repository content before cache overhead. This includes both
W4A16 serving targets and the separate Q4_0-unquantized targets required for
officially matched MTP testing. Even with a conservative 2×
