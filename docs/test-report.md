...
| Android network/reducer unit tests and build | Passed | Version 0.6.0 `testDebugUnitTest lintDebug assembleDebug assembleRelease` completed with 11 unit tests and `No issues found`. Cleartext is disabled; only `debug-overrides` permits a device-owner private CA, so the release candidate continues to trust only platform system CAs. Strict protocol envelopes, secure endpoint parsing, authenticated trusted-TLS WebSocket exchange, and reducer state remain covered |
...
| Android 0.6.0 artifacts | Passed | Debug APK 12,740,262 bytes SHA-256 `2678b96818076ee9b67bd387029d04bdd768dede74375a0a26584149911e29dc`; unsigned release APK 9,070,861 bytes SHA-256 `28be740968a356899fb5a9e5bf075fb4cdfb66171694214fe007a571e76b8f96`; AAPT2 confirmed version code 8/name 0.6.0 and API 37. APKs reside under `E:\Data\LocalVoiceAgent\artifacts\android\0.6.0-api37` |
