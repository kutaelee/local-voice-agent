...
| Network-free repository validation suite | Passed | Latest run: 10 validators completed in 4,248.15 ms using the isolated validation-capable WSL runtime; configs, manifests, contracts, catalogs, status, approval/policy, workspaces, and security defaults |
